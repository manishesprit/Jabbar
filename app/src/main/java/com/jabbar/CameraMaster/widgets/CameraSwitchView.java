...
public class CameraSwitchView extends AppCompatImageButton {
    ...
    private void initializeView() {
        ...
        frontCameraDrawable = ContextCompat.getDrawable(context, R.drawable.ic_switch_camera);
        frontCameraDrawable = DrawableCompat.wrap(frontCameraDrawable);

        rearCameraDrawable = ContextCompat.getDrawable(context, R.drawable.ic_switch_camera);
