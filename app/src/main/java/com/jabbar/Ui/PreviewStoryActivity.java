...
import com.jabbar.CameraMaster.internal.utils.ImageLoader;
...
public class PreviewStoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static Intent newIntentPhoto(Context context, String filePath) {
        return new Intent(context, PreviewStoryActivity.class)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ratioChanger.setVisibility(View.VISIBLE);
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    mediaController = new MediaController(PreviewStoryActivity.this);
